...
export declare const FrappeProvider: ({ url, tokenParams, socketPort, children }: FrappeProviderProps) => import("react/jsx-runtime").JSX.Element;
/**
 ...
 */
export declare const useFrappeAuth: (options?: Partial<import("swr/_internal").PublicConfiguration<any, any, import("swr/_internal").BareFetcher<any>>> | undefined) => {
 ...
 */
export declare const useFrappeGetDoc: <T = any>(doctype: string, name?: string | undefined, swrKey?: Key, options?: Partial<import("swr/_internal").PublicConfiguration<any, any, import("swr/_internal").BareFetcher<any>>> | undefined) => SWRResponse<FrappeDoc<T>, Error, any>;
/**
 ...
 */
export declare const useFrappeGetDocList: <T = any>(doctype: string, args?: GetDocListArgs | undefined, swrKey?: Key, options?: Partial<import("swr/_internal").PublicConfiguration<any, any, import("swr/_internal").BareFetcher<any>>> | undefined) => SWRResponse<T[], Error, any>;
/**
 ...
 *
 */
export declare const useFrappeGetDocCount: (doctype: string, filters?: Filter[] | undefined, cache?: boolean, debug?: boolean, swrKey?: Key, options?: Partial<import("swr/_internal").PublicConfiguration<any, any, import("swr/_internal").BareFetcher<any>>> | undefined) => SWRResponse<number, Error>;
/**
 ...
 * @returns an object (SWRResponse) with the following properties: data (number), error, isValidating, and mutate
 */
export declare const useFrappeGetCall: <T = any>(method: string, params?: Record<string, any> | undefined, swrKey?: Key, options?: Partial<import("swr/_internal").PublicConfiguration<any, any, import("swr/_internal").BareFetcher<any>>> | undefined) => SWRResponse<T, Error, any>;
/**
 *
 ...
 */
export declare const useFrappeDocumentEventListener: (doctype: string, docname: string, emitOpenCloseEventsOnMount: boolean | undefined, onUpdateCallback: (eventData: DocumentUpdateEventData) => void) => {
